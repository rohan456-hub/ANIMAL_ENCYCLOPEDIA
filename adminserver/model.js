...
const Userdetails= model('Userinfo',UserSchema)
...
const Admindetails= model('Admindata',AdminSchema)
...
module.exports={Messagedetails,UserNoti,Petsdetails,Admindetails,Userdetails,Animalcategory,AnimalsSchema}