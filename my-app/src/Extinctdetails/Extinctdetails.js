...
// import './Extinctdetails.css'
//

export default function Extinctdetails() {
  ...
  useEffect(() => {
    ...
    axios
      .post(apiUrl('/api/getAnimalextinctbyID'), { id: paramID })
      .then((apioutput) => {
    ...
    {/* <p>{categories.ShortDescription}</p> */}
          ...
          <div className="admain">
            ...
            <div className="adboxb">
              ...
              <h1 className="tag">Animal Sound <br /><audio src={mediaUrl(categories.Audiofile)} controls /></h1>
            </div>
          </div>
