...
const PopupMenu = ({ handleLoginLogout, user, username, loginlogout }) => {
  return (
      ...
      <nav className="popup-window">
        ...
        <ul>
          ...
          <li className="dropdown">
            <select className="login-select" onChange={handleLoginLogout}>
              <option value="">{user ? username : "Login As"}</option>
              <option className="opt" value="login">
                {loginlogout}
              </option>
            </select>
          </li>
